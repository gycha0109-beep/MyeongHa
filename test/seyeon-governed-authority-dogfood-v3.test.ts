...
import {
  runSeyeonGovernedAuthorityDogfoodV3,
} from './support/seyeon-governed-authority-dogfood-v3.js';
...
describe('Se-yeon governed authority dogfood v3', () => {
  it('survives 1,200 post-turns without promoting repeated unsupported outcomes', async () => {
    const report = await runSeyeonGovernedAuthorityDogfoodV3();
