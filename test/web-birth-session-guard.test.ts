...
import { BirthRuntimeError, createBirthRuntimeClient } from '../apps/web/birth-runtime-client.js';
...
const guestBearer = async () => ({ kind: 'guest' as const, token: 'opaque-guest-token' });
