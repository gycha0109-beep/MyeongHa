...
export interface SeyeonGovernedAuthorityDogfoodTurnTraceV3 {
...
export interface SeyeonGovernedAuthorityDogfoodReportV3 {
  readonly schemaVersion: 'seyeon-governed-authority-dogfood-v3';
  readonly turnCount: 1200;
  readonly traces: readonly SeyeonGovernedAuthorityDogfoodTurnTraceV3[];
...
function phaseForTurn(turnIndex: number): SeyeonGovernedAuthorityDogfoodTurnTraceV3['phase'] {
...
export async function runSeyeonGovernedAuthorityDogfoodV3(): Promise<SeyeonGovernedAuthorityDogfoodReportV3> {
  const ledger = new InMemorySeyeonEventLedgerV2();
  const traces: SeyeonGovernedAuthorityDogfoodTurnTraceV3[] = [];
  ...
  return Object.freeze({
    schemaVersion: 'seyeon-governed-authority-dogfood-v3' as const,
