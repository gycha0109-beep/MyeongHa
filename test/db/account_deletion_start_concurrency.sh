...
[[ "$("${psql_base[@]}" -Atc "select count(*) from information_schema.tables where table_schema='public' and table_type='BASE TABLE';")" == "65" ]] || fail "account deletion slice changed public table catalog"
pass "account deletion command PUBLIC EXECUTE remains revoked and public table catalog remains 65"
