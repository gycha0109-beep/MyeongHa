...
insert into public.conversation_threads(
  ...
  ('77400000-0000-0000-0000-000000000011','77100000-0000-0000-0000-000000000001','single_character','active','multi-participant single runtime thread','77300000-0000-0000-0000-000000000001','77200000-0000-0000-0000-000000000001',0,1,timestamptz '2026-08-31 20:30:00+00',timestamptz '2026-08-31 20:30:00+00',null);
...
insert into public.conversation_thread_characters(
  ...
  ('77500000-0000-0000-0000-000000000007','77400000-0000-0000-0000-000000000011','char-z-primary-77','77200000-0000-0000-0000-000000000001','primary',timestamptz '2026-08-31 20:30:00+00',null),
  ('77500000-0000-0000-0000-000000000008','77400000-0000-0000-0000-000000000011','char-a-participant-77','77200000-0000-0000-0000-000000000001','participant',timestamptz '2026-08-31 20:30:00+00',null);
SQL
...
expect_fail "single-Character thread with multiple active participants" "active single-Character thread must have exactly one participant in its active content bundle" \
  "select * from public.qry_chat_thread_runtime_binding_v1('77100000-0000-0000-0000-000000000001','77400000-0000-0000-0000-000000000011');"
