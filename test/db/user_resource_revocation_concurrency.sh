...
[[ "$("${psql_base[@]}" -Atc "select count(*) from information_schema.tables where table_schema='public' and table_type='BASE TABLE';")" == "65" ]] || fail "revocation slice changed public table catalog"
pass "revocation commands PUBLIC EXECUTE remain revoked and public table catalog remains 65"
