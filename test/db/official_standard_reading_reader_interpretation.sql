...
select pg_temp.assert_v2_true(
  'additional Reader purchase reuses exact official Reading and creates no new Reading',
  (
    select result.reader_character_id = 'test-unlockable-reader'
       and result.reading_session_id = '12103000-0000-0000-0000-000000000001'::uuid
       and result.reading_id = '12103100-0000-0000-0000-000000000001'::uuid
       and result.access_role = 'additional_reader'
    ...
    from public.cmd_bind_standard_reading_access_v2(
      ...
      'standard-reading-access-bind-v2',
      '{"schemaVersion":"standard-reading-access-bind-v2","purchaseIntentId":"11392300-0000-0000-0000-000000000002"}'::jsonb
    ) result
  )
