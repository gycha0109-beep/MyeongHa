...
const requiredLiveVerifierFragments = [
  ...
  'afterReSignIn.lifeRecordDigest !== beforeSignOut.lifeRecordDigest',
  'afterReSignIn.memoriesDigest !== beforeSignOut.memoriesDigest',
  ...
  'lifeRecordAfterReSignIn=200',
  'memoriesAfterReSignIn=200',
...
const forbiddenLiveVerifierFragments = [
  ...
  'console.log(lifeRecordDigest',
  'console.error(lifeRecordDigest',
  'console.log(memoriesDigest',
  'console.error(memoriesDigest',
];
