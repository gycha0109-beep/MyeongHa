...
| UC-26 | 유료 Reading/content 구매 | `COMMERCE_ENTITLEMENT`, `API_CONTRACT`, `SHARED_DOMAIN_CONTRACTS`, `COST_QUOTA_ABUSE` | §12 Commerce | COVERED-P0 / COVERED-SOURCE-GAP (`SRC-18` product→grant target + `SRC-21` event apply/aggregate projection; `P0-CM-01` Web + one-off launch rail and `P0-CM-02` PortOne V2 provider are DECIDED; launch saleability remains gated by `P0-CM-03` plus live merchant/credential/PG/channel/Production readiness) |
| UC-27 | entitlement restore | `COMMERCE_ENTITLEMENT`, `API_CONTRACT` | §12 Commerce | COVERED-P0 / COVERED-SOURCE-GAP (`SRC-18` historical source→grant target + `SRC-21` restore event/aggregate transition; `P0-CM-01` Web + one-off launch rail and `P0-CM-02` PortOne V2 provider are DECIDED; Production restore remains gated by `P0-CM-03` plus applicable live merchant/credential/PG/channel/Production readiness) |
