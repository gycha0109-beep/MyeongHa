...
Public scale / usage / revenue signals, including safe derivations and denominator warnings.
...
```text
C_chat
= ordinary committed relationship-turn cost

C_read
= governed Saju Reading execution cost
```

and models allowance sensitivity.

### `09_MONETIZATION_TIMELINE_AND_ALLOWANCE_FRICTION.md`

Normalizes competitor metrics by product-version timeline and records allowance UX failure signals.

### `10_RETENTION_DISCOVERY_AND_REFERRAL_SURFACES.md`

Separates character relationship behavior from Hall/Home monetization discovery and maps activation-gated referral logic.
...
4. **No semantic-quality corruption by price tier** — paid access may change depth/compute/artifact, but governed Saju meaning remains valid.
