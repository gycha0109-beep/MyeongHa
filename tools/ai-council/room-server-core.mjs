...
function buildRoundOneInput(meeting) {
  ...
  return `회의 주제:\n${meeting.topic}\n\n[ROUND 1 TASK]\n당신의 전문영역 책임으로 최초 분석을 제시하십시오. POSITION은 다른 트랙의 우려를 모두 섞은 중립 결론이 아니라, 당신 트랙의 가장 강한 기본 입장과 non-negotiable을 먼저 제시해야 합니다. 다른 Agent의 앞선 발언이 있으면 참고하되 그 의견에 맞추기 위해 자기 전문영역의 판단을 포기하지 마십시오. 아직 확정하지 말고, 실제 trade-off와 상대 트랙에 요구할 조건을 분명히 하십시오.\n\n아래 다섯 제목을 사용하고, 각 제목에는 최대 1개 bullet만 작성하십시오. 각 bullet은 최대 2개의 짧은 문장으로 제한하고 전체 답변은 900자 이내로 끝내십시오. 긴 배경 설명·같은 주장 반복은 금지입니다.\n\nPOSITION\n- 현재 입장과 non-negotiable\n\nREASONS\n- 핵심 근거\n\nRISKS\n- 전문영역 관점의 가장 큰 위험\n\nREQUIREMENTS FOR OTHER TRACKS\n- 상대 트랙에 요구하는 조건\n\nOPEN\n- 아직 판단할 수 없는 것\n\n[PRIOR POSITIONS IN THIS ROUND]\n${formatMessages(prior, { perMessage: 3000, total: 9000 }) || '(아직 다른 전문 Agent 발언 없음)'}`;
}
